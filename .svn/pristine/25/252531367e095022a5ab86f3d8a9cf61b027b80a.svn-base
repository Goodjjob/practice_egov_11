...
$(document).ready(function(){
	...
	var $jBtnsList = $("#submitBtnsId button");
	
	$jBtnsList.each(function(index) {
		$(this).css("border", index + "px solid #ff0000");
		$(this).html("border: " + index +"px");
	});
}); 
				...
				<div class="matter">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12"> 
								<!-- List starts -->
								<ul class="today-datas" id="todayDatasId">
									<!-- List #1 -->
									<li class="bred">
									  <!-- Graph -->
								  ...
								  <div class="padd">
									  ...
									  <div class="form quick-post">
													  ...
													  <form class="form-horizontal">
														  ...
														  <div class="form-group">
															 <!-- Buttons -->
															 <div class="col-lg-offset-3 col-lg-9" id="submitBtnsId">
